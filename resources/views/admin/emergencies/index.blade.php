                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    @forelse ($emergencies as $emergency)
                                        <tr>
                                            <td class="text-center" style="max-width: 200px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">{{ $emergency->incident }}</td>
                                            <td class="text-center">
                                                <a href="#" class="view-location" data-lat="{{ $emergency->latitude }}"
