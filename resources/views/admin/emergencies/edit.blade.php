                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.emergencies.update', $emergency->id) }}" method="POST" id="editEmergencyForm">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('incident') is-invalid @enderror" id="incident" name="incident" rows="3"
                                    required>{{ old('incident', $emergency->incident) }}</textarea>
                                @error('incident')
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('latitude') is-invalid @enderror"
                                        id="latitude" name="latitude" value="{{ old('latitude', $emergency->latitude) }}"
                                        required>
                                    @error('latitude')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('longitude') is-invalid @enderror"
                                        ...
                                        value="{{ old('longitude', $emergency->longitude) }}" required>
                                    @error('longitude')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
