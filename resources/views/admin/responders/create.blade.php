...
@section('content')
            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header">
                        <h2 class="mb-0" style="font-size:1.5rem;"><i class="bi bi-person-plus"></i> Add New Responder</h2>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form action="{{ route('admin.responders.store') }}" method="POST" id="createResponderForm">
                            @csrf
                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control @error('responder_code') is-invalid @enderror" 
                                                            id="responder_code" name="responder_code" value="{{ old('responder_code') }}" required>
                                ...
                                <!-- Hidden role field (locked to responder) -->
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-primary" id="submitBtn">
                                    ...
                                    <i class="bi bi-save"></i> Create Responder
                                </button>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        ...
        const form = document.getElementById('createResponderForm');
