            ...
            <div class="col-md-10">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.responders.update', $responder) }}" method="POST"
                            id="editResponderForm">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text"
                                                            class="form-control @error('responder_code') is-invalid @enderror"
                                                            id="responder_code" name="responder_code"
                                                            value="{{ old('responder_code', $responder->responder_code) }}"
                                                            required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            id="name" name="name" value="{{ old('name', $responder->user->name) }}"
                                            required>
                                        @error('name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                            id="phone" name="phone"
                                            value="{{ old('phone', $responder->user->phone) }}" pattern="[0-9]{10}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ old('date_of_birth', $responder->user->userInfo->date_of_birth->format('Y-m-d')) }}"
                                            required>
                                        @error('date_of_birth')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
