...
@section('content')
    ...
    <div class="container">
        ...
        <h2 class="mb-4" style="font-size:1.5rem;"><i class="bi bi-pencil-square"></i> Edit Branch</h2>
                                ...
                                <select class="form-select @error('service_id') is-invalid @enderror" id="service_id"
                                    ...
                                    @foreach ($services as $service)
                                        <option value="{{ $service->id }}"
                                            {{ old('service_id', $branch->service_id) == $service->id ? 'selected' : '' }}>
                                            {{ $service->name }}</option>
                                    @endforeach
                                </select>
                                @error('service_id')
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="mb-3 position-relative">
                                ...
                                <textarea class="form-control @error('address') is-invalid @enderror" id="address" name="address" rows="2"
                                    autocomplete="off" required>{{ old('address', $branch->address) }}</textarea>
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <input type="number" step="any"
                                        ...
                                        name="latitude" value="{{ old('latitude', $branch->latitude) }}">
                                    @error('latitude')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col">
                                    ...
                                    <input type="number" step="any"
                                        ...
                                        name="longitude" value="{{ old('longitude', $branch->longitude) }}">
                                    @error('longitude')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
